 ...
 */
export function fixListOfWagons([first, second, ...restOfTheIds]) {
  return [...restOfTheIds, first, second];
}
 ...
 */
export function correctListOfWagons([first, ...restOfTheIds], missingWagons) {
  return [first, ...missingWagons, ...restOfTheIds];
}
 ...
 */
export function separateTimeOfArrival({timeOfArrival, ...restOfTheInformation}) {
  return [timeOfArrival, {...restOfTheInformation}];
}
